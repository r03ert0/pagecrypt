...
<head>
  ...
  <script type="module">
//assets/index.791c84e2.js
const O=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerpolicy&&(a.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?a.credentials="include":r.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=s(r);fetch(r.href,a)}};O();function M(t,e,s){var i;if(s===void 0&&(s={}),!e.codes){e.codes={};for(var r=0;r<e.chars.length;++r)e.codes[e.chars[r]]=r}if(!s.loose&&t.length*e.bits&7)throw new SyntaxError("Invalid padding");for(var a=t.length;t[a-1]==="=";)if(--a,!s.loose&&!((t.length-a)*e.bits&7))throw new SyntaxError("Invalid padding");for(var o=new((i=s.out)!=null?i:Uint8Array)(a*e.bits/8|0),n=0,c=0,f=0,l=0;l<a;++l){var b=e.codes[t[l]];if(b===void 0)throw new SyntaxError("Invalid character "+t[l]);c=c<<e.bits|b,n+=e.bits,n>=8&&(n-=8,o[f++]=255&c>>n)}if(n>=e.bits||255&c<<8-n)throw new SyntaxError("Unexpected end of data");return o}function N(t,e,s){s===void 0&&(s={});for(var i=s,r=i.pad,a=r===void 0?!0:r,o=(1<<e.bits)-1,n="",c=0,f=0,l=0;l<t.length;++l)for(f=f<<8|255&t[l],c+=8;c>e.bits;)c-=e.bits,n+=e.chars[o&f>>c];if(c&&(n+=e.chars[o&f<<e.bits-c]),a)for(;n.length*e.bits&7;)n+="=";return n}var S={chars:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",bits:6},P={parse:function(e,s){return M(e,S,s)},stringify:function(e,s){return N(e,S,s)}};const x=document.querySelector.bind(document),[d,p,T,y,h]=["input","header","#msg","form","#load"].map(x);let L,E,g;document.addEventListener("DOMContentLoaded",async()=>{const t=x("pre").innerText;if(!t){d.disabled=!0,m("No encrypted payload.");return}const e=P.parse(t);L=e.slice(0,32),E=e.slice(32,32+16),g=e.slice(32+16),localStorage.passphrase?(d.value=localStorage.passphrase,await K()):(w(h),v(y),p.classList.replace("hidden","flex"),d.focus())});var k,A;const u=((k=window.crypto)==null?void 0:k.subtle)||((A=window.crypto)==null?void 0:A.webkitSubtle);u||(m("Please use a modern browser."),d.disabled=!0);function v(t){t.classList.remove("hidden")}function w(t){t.classList.add("hidden")}function m(t){T.innerText=t,p.classList.add("text-red-600")}y.addEventListener("submit",async t=>{t.preventDefault(),await K()});async function C(t){return new Promise(e=>setTimeout(e,t))}async function K(){localStorage.passphrase=d.value,h.lastElementChild.innerText="Loading...",w(p),w(y),v(h),await C(60);try{const t=await F({salt:L,iv:E,ciphertext:g},d.value);document.write(t),document.close()}catch(t){w(h),v(y),p.classList.replace("hidden","flex"),sessionStorage.k?sessionStorage.removeItem("k"):m("Wrong password."),d.value="",d.focus()}}async function D(t,e){const s=new TextEncoder,i=await u.importKey("raw",s.encode(e),"PBKDF2",!1,["deriveKey"]);return await u.deriveKey({name:"PBKDF2",salt:t,iterations:2e6,hash:"SHA-256"},i,{name:"AES-GCM",length:256},!0,["decrypt"])}async function I(t){return u.importKey("jwk",t,"AES-GCM",!0,["decrypt"])}async function F({salt:t,iv:e,ciphertext:s},i){const r=new TextDecoder,a=sessionStorage.k?await I(JSON.parse(sessionStorage.k)):await D(t,i),o=new Uint8Array(await u.decrypt({name:"AES-GCM",iv:e},a,s));if(!o)throw"Malformed data";return sessionStorage.k=JSON.stringify(await u.exportKey("jwk",a)),r.decode(o)}<\/script>
